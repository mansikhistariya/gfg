<h2><a href="https://www.geeksforgeeks.org/problems/pattern-of-strings3829/1?page=5&difficulty=School&sortBy=submissions">Pattern of Strings</a></h2><h3>Difficulty Level : School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a string <strong>S</strong> of length <strong>N</strong>, find the pattern of the strings as shown below in the examples.</span></p>
