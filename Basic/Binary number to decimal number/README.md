<h2><a href="https://www.geeksforgeeks.org/problems/binary-number-to-decimal-number3525/1?page=4&difficulty=Basic&sortBy=submissions">Binary number to decimal number</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p>Given a Binary Number <strong>B</strong>, find&nbsp;its decimal equivalent.<br>
&nbsp;</p>
